...
from ..core import MachineError, listify, State, EventData, Callback
...
class Timeout(State):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self._on_timeout: Optional[Union[List[Union[str, Callback]], Any]] = None
        if self.timeout > 0:
            try:
    ...
    @on_timeout.setter
    def on_timeout(self, value: Union[str, Callback, List[Union[str, Callback]]]) -> None:
...
class Retry(State):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self.on_failure: Optional[Union[str, Callback]] = kwargs.pop('on_failure', None)
